...
public class EventController {
    ...
    public ResponseEntity<Event> create(
        ...
        EventRequestDTO eventRequestDTO = new EventRequestDTO(title, description, date, city, remote, eventUrl, image);
    ...
    public ResponseEntity<List<EventResponseDTO>> getFilteredEvents(
        ...
        List<EventResponseDTO> events = eventService.getFilteredEvents(page, size, title, city, startDate, endDate);
